  ...
  return `
    <div class="gauge-shell" role="img" aria-label="${label} ${normalized}">
      ...
      <svg class="gauge-svg" viewBox="0 0 185 122" aria-hidden="true">
        ...
        <text class="gauge-min" x="41" y="107">0</text>
        <text class="gauge-mid" x="88" y="62">50</text>
        <text class="gauge-max" x="123" y="107">100</text>
      </svg>
...
function mountGauge(element, options = {}) {
  ...
  let label = options.label ?? element.dataset.gaugeLabel ?? "Gauge";
  ...
  return {
    setValue(nextValue, nextLabel = label) {
